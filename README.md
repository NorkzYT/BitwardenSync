...
BitwardenSync also works on its own, without an export tool such as [BackupOnePass](https://github.com/NorkzYT/BackupOnePass). Place the input file in the directory mentioned above and it processes the data automatically as described.
...
- [**docker**](./docker)
  ...
  - [**src**](./docker/src)
    - [api.ts](./docker/src/api.ts)
    - [cli.ts](./docker/src/cli.ts)
    - [config.ts](./docker/src/config.ts)
    - [crypto.ts](./docker/src/crypto.ts)
    - [log.ts](./docker/src/log.ts)
    - [purge.ts](./docker/src/purge.ts)
  - [**tests**](./docker/tests)
    - [api.test.ts](./docker/tests/api.test.ts)
    - [config.test.ts](./docker/tests/config.test.ts)
    - [crypto.test.ts](./docker/tests/crypto.test.ts)
    - [purge.test.ts](./docker/tests/purge.test.ts)
  - [tsconfig.json](./docker/tsconfig.json)
